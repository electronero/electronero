...
ENTRYPOINT ["electronerod", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=22089", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=22090", "--non-interactive", "--confirm-external-bind"]
